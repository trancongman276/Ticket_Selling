import 'package:CoachTicketSelling/MainPage/TicketUI.dart';
                    ...
                    children: <Widget>[
                      ...
                      Container (
                              child: FlatButton (
                                ...
                                onPressed: () {
                                  print("Choose");
                                  Navigator.push(context, MaterialPageRoute(builder:(context) => TicketUI()));
                                },
                                color: Colors.green,
        ...
        children: <Widget>[
          Container (
              ...
              child: (() {
                // your code here
                if ( stateSeat[index] == 3) {
                  return Image.asset('assets/images/seat.png', fit: BoxFit.fill,);
                } else if (stateSeat[index] == 1) {
                  return Image.asset('assets/images/seatSelect.png', fit: BoxFit.fill,);
                } else if (stateSeat[index] == 2){
                  return Image.asset('assets/images/seatChoose.png', fit: BoxFit.fill,);
                }
              }())),
          Text (
            "$numSeat",
